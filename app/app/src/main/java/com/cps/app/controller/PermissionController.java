...
public class PermissionController {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<ApiResponse<PermissionDto>> updatePermission(@RequestBody Permission permission, @PathVariable Long id){
    	return permissionService.updatePermission(permission, id);
    	
    }
    
    @DeleteMapping("/{id}")
    public ResponseEntity<ApiResponse<PermissionDto>> deletePermission(@PathVariable Long id){
